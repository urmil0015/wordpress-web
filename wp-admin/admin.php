...
add_action('wp_dashboard_setup', 'custom_widgetsss');

function custom_widgetsss(){
    
    global $wp_meta_boxes;
    
    
    wp_add_dashboard_widget('custom_help_widget', 'Theme Support', 'custom_dahsboard_help');

}

function custom_dahsboard_help(){
    echo "<h1>Taani partnerrrrrr</h1>";
    echo "<h1>Ham hai rahi pyaar ke</h1>";
    echo "<h1>Fir milenge</h1>";
    echo "<h1>Chalte chalte</h1>";
}
